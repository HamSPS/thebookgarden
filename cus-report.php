...
<div class="container-fluid" style="margin-top: 15px">
            ...
            <p class="d-flex justify-content-end">
                <a href="report/cus-report-print.php" class="btn btn-info" target="_blank"><i class="fas fa-print"></i> ພີມລາຍງານ</a>
            </p>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td><?= $row['tel'] ?></td>
                            <td><?= $row['email'] ?></td>
                            <td><img src="<?= $row['img'] ?>" alt="ຮູບລູກຄ້າ" width="75px"></td>
                            <td style="text-align: center;"><a href="#" onclick="viewcard()" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="ແກ້ໄຂ"><i class="fas fa-print"></i> ສະແດງ</a></td>
                        </tr>
                        <?php
                    }
                    ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <a href="report/cus-membership.php?cusID=<?= $row['cusID'] ?>" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="ແກ້ໄຂ"><i class="fas fa-print"></i> ພິມບັດ</a>
