                        ...
                        <form action="login.php" method="post">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="username" id="username" class="form-control py-4"
                                    placeholder="ອີເມວ ຫຼື ຊື່ຜູ້ໃຊ້" required>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                ...
                                <input type="password" name="pwd" id="pwd" class="form-control py-4"
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <input type="submit" value="ເຂົ້າໃຊ້ລະບົບ" name="btnLogin" class="btn btn-success"
                                    style="width:200px;">
                            </div>
                        </form>
                    </div>
