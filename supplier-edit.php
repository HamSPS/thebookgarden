<?php
    ...
    if(isset($_POST['btnAdd'])){
        ...
        $sup_address = $_POST['sup_address'];
            ...
            $sql = "UPDATE tbsuppliers SET sup_Name = '$sup_name',contactName = '$contact',sup_tel = '$sup_tel',sup_email = '$sup_email',sup_address = '$sup_address' WHERE sup_id = '$sup_id'";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="sup_id" name="sup_id" value="<?= @$sup_id ?>" placeholder="ກະລຸນາປ້ອນລະຫັດ" readonly>
