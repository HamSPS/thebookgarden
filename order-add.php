        ...
        <div class="row">
            <div class="col-md-7">
                    <div class="d-flex">
                        ...
                        <p class="p-2"><a href="show-order.php" class="btn btn-secondary"><i class="fa fa-newspaper"></i> ສະແດງລາຍການສັ່ງຊື້</a></p>
                    </div>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">ລາຍການສິນຄ້າ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="rev-tabs" data-toggle="tab" href="#reserv" role="tab" aria-controls="reserv" aria-selected="false">ລາຍການທີ່ຈອງ</a>
                        </li>
                    </ul>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="35px">
                                                <a href="order-add.php?b_id=<?= $row["Bkid"] ?>&act=add" class="btn btn-success">ເພີ່ມ</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                ...
                                <table class="display table table-hover table-border" id="show">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['qty'] ?></td>
                                            <td><?= $row['cusName'] ?></td>
                                            <td><a href="order-add.php?b_id=<?= $row["bid"] ?>&oqty=<?= $row["qty"]?>&act=forder" class="btn btn-success">ເພີ່ນ</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                    ...
                    <table class="table table-hover">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td align="center"><a href="order-add.php?b_id=<?= $b_id ?>&act=remove" class="btn btn-danger"><i class="fas fa-trash"></i> ລົບ</a></td>
                                </tr>
                                <?php 
